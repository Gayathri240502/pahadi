  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography variant="body1" paragraph>
        Welcome to Pahadi! These terms and conditions outline the rules and regulations for the use of Pahadi's Website.
      </Typography>
      <Typography variant="body1" paragraph>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use Pahadi if you
      ...
      <Typography variant="body1" paragraph>
        Unless otherwise stated, Pahadi and/or its licensors own the intellectual property rights for all material on
        Pahadi. All intellectual property rights are reserved. You may access this from Pahadi for your own personal use
      ...
      <Typography variant="body1" paragraph>
        ...
        certain areas of the website. Pahadi does not filter, edit, publish or review Comments prior to their presence
        on the website. Comments do not reflect the views and opinions of Pahadi, its agents, and/or affiliates.
