...
export const metadata = {
  title: 'Order Confirmation | Pahadi - Your Order Has Been Successfully Placed',
  description:
    'Congratulations! Your order has been successfully placed on Pahadi. Thank you for choosing us for your shopping needs. Expect fast processing and delivery. Stay tuned for updates on your order status. Shop more with Pahadi!',
  applicationName: 'Pahadi',
  authors: 'Pahadi',
  keywords:
    'order confirmation, Pahadi, order placed, successful order, order processing, order delivery, order status, order updates, fast delivery, shopping confirmation, shopping success, shopping updates, online shopping'
};
